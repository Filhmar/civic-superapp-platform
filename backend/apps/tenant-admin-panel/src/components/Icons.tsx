...
/** The white volcano brand mark (triangle + crater notch) used on logo tiles. */
export function VolcanoMark({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
      ...
      <path d="M9.8 8.6 L12 5.2 L14.2 8.6 L12.6 7.6 L12 8.4 L11.4 7.6 Z" fill={crater} />
      {spark && <circle cx="18.6" cy="5" r="1.7" fill="var(--accent)" />}
    </svg>
  );
}
